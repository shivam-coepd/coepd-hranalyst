...
('offer_accepted','placed','Placement HR confirms accepted offer'),
('offer_accepted','selected','Offer withdrawn before placement'),
('under_verification','verification_pending','Verification claim released'),
('interview_completed','interview_scheduled','Next client interview round'),
