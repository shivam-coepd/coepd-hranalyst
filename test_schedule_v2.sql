...
CREATE OR REPLACE FUNCTION public.schedule_client_interview_debug(
...
declare
    v_actor uuid := '57aa8f10-eda9-48e0-a9d5-23af5d1aee73'::uuid;
...
begin
    ...
    insert into public.notification_outbox (event_type, channel, recipient_user_id, entity_type, entity_id, payload, dedupe_key)
    select 'CLIENT_INTERVIEW_SCHEDULED', 'in_app', ur.user_id, 'interview', v_interview_id, jsonb_build_object('interview_id', v_interview_id, 'application_id', v_application_id, 'company_id', v_company_id, 'scheduled_at', p_scheduled_at), 'interview:' || v_interview_id::text || ':admin:' || ur.user_id::text
...
SELECT public.schedule_client_interview_debug(
    '8787fbc2-5201-40d3-a2b2-3562197b89d1'::uuid,
    1,
    'Round 1',
    'technical',
